    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">₹{{ number_format($stats['total_value'], 2) }}</h4>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="collapse {{ request()->hasAny(['search', 'stock_status', 'quantity_min', 'quantity_max', 'amount_min', 'amount_max', 'date_from', 'date_to']) ? 'show' : '' }}" id="filterCollapse">
                <div class="card-body">
                    <form method="GET" action="{{ route('inventory.index') }}" id="filterForm">
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="quantity_min" class="form-control" placeholder="Min" value="{{ request('quantity_min') }}" min="0">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Quantity Max</label>
                                <input type="number" name="quantity_max" class="form-control" placeholder="Max" value="{{ request('quantity_max') }}" min="0">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" name="amount_min" class="form-control" placeholder="Min amount" value="{{ request('amount_min') }}" min="0">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Amount Max (₹)</label>
                                <input type="number" step="0.01" name="amount_max" class="form-control" placeholder="Max amount" value="{{ request('amount_max') }}" min="0">
                            </div>
                            <div class="col-md-3">
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $item->isOutOfStock() ? 'danger' : ($item->isLowStock() ? 'warning' : 'success') }}-subtle text-{{ $item->isOutOfStock() ? 'danger' : ($item->isLowStock() ? 'warning' : 'success') }}">
                                        {{ $item->quantity }}
                                    </span>
                                </td>
                                ...
                                <td>
                                    <ul class="list-inline hstack gap-2 mb-0 justify-content-end">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0);" class="adjust-item-btn" 
                                               data-bs-toggle="modal" 
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                               required placeholder="Enter item name" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="1" min="0" name="quantity" 
                               ...
                               required placeholder="Enter initial quantity" value="{{ old('quantity') }}">
                        @error('quantity')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" name="amount" 
                               ...
                               required placeholder="Enter unit price" value="{{ old('amount') }}">
                        @error('amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="1" min="1" name="change_qty" id="adjust_qty" 
                               class="form-control @error('change_qty') is-invalid @enderror" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="reason" class="form-control @error('reason') is-invalid @enderror" 
                                  rows="3" required placeholder="Enter reason for adjustment"></textarea>
                        @error('reason')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
