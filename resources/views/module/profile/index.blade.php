            ...
            <div class="col">
                <div class="p-2">
                    ...
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i
                                class="ri-mail-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $user->email }}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex profile-wrapper">
                    @if(Auth::id() === $user->id)
                        <div class="flex-shrink-0">
                            <a href="{{ route('profile.settings') }}" class="btn btn-success"><i
                            ...
                            <div class="col-xxl-9">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p>Welcome to your profile page. Here you can view and manage your account
                                            information.</p>
                                        <div class="row">
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0">{{ $user->role->name ?? 'User' }}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <a href="mailto:{{ $user->email }}"
                                                            class="fw-semibold">{{ $user->email }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
