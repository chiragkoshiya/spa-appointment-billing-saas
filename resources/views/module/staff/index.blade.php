                    ...
                    <table class="table align-middle table-nowrap mb-0" id="staffTable">
                        ...
                        <tbody class="list form-check-all">
                            ...
                            <tr>
                                ...
                                <td class="status">
                                    <span class="badge bg-{{ $member->is_active ? 'success' : 'danger' }}-subtle text-{{ $member->is_active ? 'success' : 'danger' }} text-uppercase">
                                ...
                                <td>
                                    <ul class="list-inline hstack gap-2 mb-0">
                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View Documents">
                                            <a href="{{ route('staff.show', $member->id) }}" class="text-primary d-inline-block">
