    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">₹{{ number_format($stats['total_pending'], 2) }}</h4>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">₹{{ number_format($stats['today_revenue'], 2) }}</h4>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="collapse {{ request()->hasAny(['search', 'customer_id', 'payment_mode', 'payment_status', 'amount_min', 'amount_max', 'date_from', 'date_to']) ? 'show' : '' }}" id="filterCollapse">
                <div class="card-body">
                    <form method="GET" action="{{ route('invoices.index') }}" id="filterForm">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label class="form-label">Search</label>
                                <input type="text" name="search" class="form-control" placeholder="Invoice ID, Customer name/phone..." value="{{ request('search') }}">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="sort_by" class="form-select">
                                    ...
                                    <option value="id" {{ request('sort_by') == 'id' ? 'selected' : '' }}>Invoice ID</option>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" step="0.01" name="amount_min" class="form-control" placeholder="Min" value="{{ request('amount_min') }}" min="0">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Amount Max (₹)</label>
                                <input type="number" step="0.01" name="amount_max" class="form-control" placeholder="Max" value="{{ request('amount_max') }}" min="0">
                            </div>
                            <div class="col-md-3">
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $invoice->payment_mode == 'cash' ? 'info' : 'primary' }}-subtle text-{{ $invoice->payment_mode == 'cash' ? 'info' : 'primary' }} text-uppercase">
                                ...
                                <td>
                                    <ul class="list-inline hstack gap-2 mb-0 justify-content-end">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="{{ route('invoices.download', $invoice->id) }}" class="btn btn-sm btn-soft-success" target="_blank">
                                                <i class="ri-download-line"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0);" class="share-invoice-btn btn btn-sm btn-soft-warning" 
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="payment_mode" id="edit_payment_mode" class="form-select @error('payment_mode') is-invalid @enderror" required>
