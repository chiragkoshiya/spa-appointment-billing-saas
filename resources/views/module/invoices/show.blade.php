                ...
                <div class="card-body">
                    <div class="invoice-title">
                        <div class="mb-4">
                            ...
                            @if($invoice->appointment)
                                <p class="text-muted mb-0">Appointment ID:
                                    #APT{{ str_pad($invoice->appointment->id, 4, '0', STR_PAD_LEFT) }}</p>
                            @endif
                        </div>
                        <div class="text-end">
                            <a href="{{ route('invoices.download', $invoice->id) }}" class="btn btn-success me-2"
                                target="_blank">
                                <i class="ri-download-line me-1"></i> Download
                            </a>
                            <a href="javascript:void(0);" class="btn btn-warning share-invoice-btn"
                    ...
                    <div class="mt-4">
                        <div class="text-end">
                            ...
                            <a href="javascript:void(0);" class="btn btn-primary edit-item-btn" data-bs-toggle="modal"
                                data-bs-target="#editModal" data-id="{{ $invoice->id }}"
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select name="payment_mode" id="edit_payment_mode" class="form-select" required>
                                ...
                                <option value="online" {{ $invoice->payment_mode == 'online' ? 'selected' : '' }}>Online
                                </option>
                            </select>
                        </div>
                        <div class="mb-3">
