                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-info-subtle text-info text-capitalize">{{ $offer->discount_type }}</span>
                                </td>
                                <td>{{ $offer->discount_type == 'percentage' ? $offer->discount_value . '%' : '₹' . number_format($offer->discount_value, 2) }}</td>
                                <td>{{ \Carbon\Carbon::parse($offer->start_date)->format('d M, Y') }}</td>
                                <td>{{ \Carbon\Carbon::parse($offer->end_date)->format('d M, Y') }}</td>
                                <td>
                                    <span class="badge bg-{{ $offer->is_active ? 'success' : 'danger' }}-subtle text-{{ $offer->is_active ? 'success' : 'danger' }} text-uppercase">
            ...
            <form action="{{ route('offers.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="e.g. Diwali Special" required>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="discount_value" step="0.01" class="form-control" placeholder="0.00" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Discount Value</label>
                            <input type="number" name="discount_value" id="edit_value" step="0.01" class="form-control" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" id="edit_status">
